...
{{--                    <li class="menu-title">Apps</li>--}}
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('sub-category.add')}}">Add Sub Category Module</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="tasks-list.html">Manage Customer</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="contacts-grid.html">Add User</a></li>
                            <li><a href="contacts-list.html">Manage User</a></li>
                        </ul>
                    </li>
